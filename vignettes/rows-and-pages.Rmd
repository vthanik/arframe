...
underneath (when `indent_by` is not set, it is inferred from
`group_label`). Setting `group_bold = TRUE` renders the injected header
rows in bold — for finer control, use `fr_styles()` instead.
