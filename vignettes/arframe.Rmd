...
arframe produces regulatory-grade clinical tables in RTF and PDF from a
single pipeline. You describe *what* the table looks like; arframe handles
...
```{r demog-preview, echo = FALSE, out.width = "100%", fig.cap = "Demographics table rendered to PDF"}
